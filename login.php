 ...
 *
 * Proses autentikasi ditangani oleh auth/proses_login.php,
 * yang akan memverifikasi username/password ke database
 * dan mengarahkan user ke dashboard sesuai role masing-masing.
 */

require_once __DIR__ . '/config/config.php';
require_once __DIR__ . '/includes/auth.php';

// Jika user sudah login, langsung arahkan ke dashboard sesuai role-nya
...
// Ambil pesan error dari session (akan diisi oleh proses login di Tahap 5)
